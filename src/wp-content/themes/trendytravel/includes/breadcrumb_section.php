<?php
	...
	if(dt_theme_option('general', 'disable-breadcrumb') != "on"):
		...
		//ASSIGNING VALUES...
		if($sub_bg != ''): ?>
			<section class="fullwidth-background sub-parallax" style="background-image:url(<?php echo $sub_bg; ?>); background-repeat:<?php echo $sub_re; ?>; background-position:<?php echo $sub_po; ?>"><?php
			if($sub_co != ''): ?>
				<div class="breadcrumb-wrapper" style="background-color:rgba(<?php echo $sub_co[0]; ?>, <?php echo $sub_co[1]; ?>, <?php echo $sub_co[2]; ?>, 0.9);"><?php
			else: ?>
