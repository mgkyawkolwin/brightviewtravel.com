	...
	if($wp_query->have_posts()): ?>
      ...
      <div class="search-container" id="entry-search">
          <form name="frmsearch" action="<?php the_permalink(); ?>" method="get">
              <p><input type="text" name="search_text" value="<?php echo $search_text; ?>" placeholder="<?php _e('Search by name, address, offer etc...', 'iamd_text_domain'); ?>" /></p>
			...
			<div class="<?php echo $li_class." ".strtolower(implode(" ", $terms)); ?>">
                <div class="hotel-item hotel-list-view">
                    ...
                    <div class="hotel-details">
						...
						<a href="<?php the_permalink(); ?>#hotel_map_<?php the_ID(); ?>" class="map-marker small"> <span class="red"></span><?php _e('View on Map', 'iamd_text_domain'); ?></a>
     ...
     <div style="display:none;">
         <div id="booknow_wrapper" class="booknow-container">
            ...
            <form name="frmbooknow" class="booknow-frm" action="<?php echo get_template_directory_uri(); ?>/framework/booknow.php" method="post">
                ...
                <p><input type="text" name="txtdate" required="required" placeholder="<?php _e('Date Arrival (required)', 'iamd_text_domain'); ?>" /></p>
                <p><input type="text" name="txtsubject" placeholder="<?php _e('Subject', 'iamd_text_domain'); ?>" /></p>
