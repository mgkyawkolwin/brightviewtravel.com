        ...
        <div id="integration-general">
        	<?php $integration_general = array( 
					array(
						...
						"tooltip"=>		__('Any code you place here will appear in the head section of every page of your site. This is useful when you need to add javascript or css to all pages.','iamd_text_domain'),
					...
					array(
						...
						"tooltip"=>		__('You can paste your Google Analytics or other website tracking codes in this box. This will be automatically added above the &lt;/body&gt; tag.','iamd_text_domain'), 
						"textarea"=>	"body-code",
	  ...
	  <?php endforeach;?>
        ...
        <div id="integration-gallery">
            ...
            <div class="bpanel-box">
               ...
               <div class="box-content">
               <p class="note no-margin"><?php _e("Manage social media bookmark options and its layout to show in the gallery.<br><img src=\"http://www.ten28.com/qa.jpg\">",'iamd_text_domain');?></p>
               <?php global $dt_theme_social_bookmarks;
			   		  unset($dt_theme_social_bookmarks[2], $dt_theme_social_bookmarks[3], $dt_theme_social_bookmarks[6]);
                      $count = 1;
                      foreach($dt_theme_social_bookmarks as $social_bookmark):?>
