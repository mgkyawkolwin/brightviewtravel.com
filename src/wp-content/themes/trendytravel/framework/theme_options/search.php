                ...
                <div class="box-content">
                    ...
                    <div class="column one-half">
                        ...
                        <div class="smodule-price">
                            ...
                            <?php $cities = dt_theme_option("smodule","location-for-hotels");
                                  $cities = is_array($cities) ? array_filter($cities) : array();
                                  $cities = array_unique( $cities);
                                foreach( $cities as $city ){ ?>
                                <div class="smodule-price-container">
                                    <input type="text" class="medium" name="<?php echo "mytheme[smodule][location-for-hotels][]";?>" value="<?php echo $city;?>">
                                    <a href='' class='remove-price-item'><?php _e('Remove','iamd_text_domain');?></a>
                                </div>
                            <?php } ?>
                            <div class="clone hidden">
                                <div class="smodule-price-container">
                                    <input type="text" class="medium" name="<?php echo "mytheme[smodule][location-for-hotels][]";?>" value="">
                                    <a href='' class='remove-price-item'><?php _e('Remove','iamd_text_domain');?></a>
                                </div>
                            </div>	
                        </div><!-- Range -->
