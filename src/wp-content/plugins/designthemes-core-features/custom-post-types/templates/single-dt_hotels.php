<?php get_header();
	...
	while(have_posts()): the_post();
	  ...
	  //RATING CALCULATION...
	  $notes = array( 0 => 'No Rating Yet', 1 => 'Very Poor', 2 => 'Not that bad', 3 => 'Average', 4 => 'Good', 5 => 'Perfect');
	  ...
	  $map_code = '<div class="widget">';
		...
		$map_code .= '<div id="hotel_map_'.get_the_ID().'" class="list-hotel-map" data-add="'.get_the_title().', '.@$meta_set['hotel_add'].'" data-lt="'.@$meta_set['hotel_lat'].'" data-lg="'.@$meta_set['hotel_long'].'"></div>';
	  $map_code .= '</div>'; ?>
          ...
          <div class="container">
            ...
            <?php endif; ?>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<h1 class="section-title hotel-title"><?php the_title(); ?></h1><sub><?php echo $meta_set['hotel_add'];?></sub><?php
