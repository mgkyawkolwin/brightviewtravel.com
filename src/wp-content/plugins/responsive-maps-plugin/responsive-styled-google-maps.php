...
function responsive_map_css() {
    wp_register_style('responsive_map_css', plugins_url('includes/css/rsmaps.css', __FILE__), false, '2.22');
...
function admin_responsive_map_css($hook) {
    ...
    wp_register_style('responsive_map_css', plugins_url('includes/css/rsmaps.admin.css', __FILE__), false, '2.22');
    wp_enqueue_style('responsive_map_css');
}
...
function admin_responsive_map_scripts($hook) {
    ...
    if (is_ssl()) {
            wp_register_script('googlemapsapi', 'https://maps-api-ssl.google.com/maps/api/js?sensor=false&v=3.exp', array( 'jquery' ), null, false);
    } else {
            wp_register_script('googlemapsapi', 'http://maps.googleapis.com/maps/api/js?sensor=false&v=3.exp', array( 'jquery' ), null, false);
    }
    wp_register_script('jquerygmap', plugins_url('includes/js/jquery.gmap.min.js', __FILE__), array('jquery'), '3.3.3');
    wp_register_script('rsmaps', plugins_url('includes/js/rsmaps.admin.js', __FILE__), array('jquery'), '2.22');
                    ...
                    $.fn[ev] = function () {
                      ...
                      jQuery('.responsive-map').each(function(){
                          if (jQuery(this).data('gmap')) {
                              ...
                              var popup = <?php echo toBool($atts['popup']); ?>;
